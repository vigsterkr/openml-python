...
class AbstractConverter(object):
    ...
    @staticmethod
    @abstractmethod
    def from_flow(flow, components=None, initialize_with_defaults=True):
    ...
    def _deserialize_model(flow, keep_defaults):
        ...
        AbstractConverter._check_dependencies(flow.dependencies)
        ...
        for name in parameters:
            ...
            rval = AbstractConverter.from_flow(value, components=components_, initialize_with_defaults=keep_defaults)
        ...
        for name in components:
            ...
            rval = AbstractConverter.from_flow(value, **kwargs)
            parameter_dict[name] = rval
        ...
        if keep_defaults:
            ...
            param_defaults, _ = AbstractConverter._get_fn_arguments_with_defaults(model_class.__init__)
